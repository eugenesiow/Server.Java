...
/**
 * An Jena in-memory data source of Basic Linked Data Fragments.
 *
 * @author Eugene Siow
 */
public class JenaMemDataSource extends DataSource {

    private final Model datasource;
    private Map<String,Long> sizeCache;
    static Logger log = Logger.getLogger(JenaMemDataSource.class.getName());

    public JenaMemDataSource(String title, String description, String preloadFile) throws IOException {
        super(title, description);
//        System.out.println(TdbDirectory);
        datasource = RDFDataMgr.loadModel(preloadFile);
